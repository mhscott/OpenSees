...
void* OPS_FedeasConcr1Material()
{
  ...
  UniaxialMaterial* mat = new FedeasConcr1Material(tag,data[0],data[1],data[2],data[3]);
  if (mat == 0) {
    opserr << "WARNING: failed to create FedeasConcr1 material\n";
    return 0;
  }
