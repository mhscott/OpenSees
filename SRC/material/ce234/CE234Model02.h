...
// CE234Model02.  CE234Model02 provides the abstraction
// for a one-dimensional rate-dependent plasticity model
// with isotropic hardening and linear viscosity.

#ifndef CE234Model02_h
#define CE234Model02_h

#include <UniaxialMaterial.h>

#define MAT_TAG_CE234Model02   1976

class CE234Model02 : public UniaxialMaterial
{
 public:
  CE234Model02(int tag, double E, double sigmaY, double sigmaYInf,
	       double delta, double eta = 0.0);
  CE234Model02();
  ~CE234Model02();
